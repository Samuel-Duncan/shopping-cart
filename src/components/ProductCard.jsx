      ...
      <div className="w-full max-w-sm rounded-lg border border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="px-5 pb-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <a
              href="#"
              className="rounded-lg bg-[#050708] px-5 px-5 py-2.5 py-2.5 text-center text-center text-lg text-sm font-medium font-medium text-neutral-300 hover:bg-[#050708]/90 focus:outline-none focus:ring-4 focus:ring-neutral-300"
            >
              Add to cart
            </a>
          </div>
